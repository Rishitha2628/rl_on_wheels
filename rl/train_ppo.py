#!/usr/bin/env python3
"""Training entrypoint for PPO on TurtleBot3."""
...
from agents.ppo_agent import build, load
from envs.ros2_gym_env import TurtleBot3Env


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Train PPO on TurtleBot3")
    p.add_argument("--config",     default="/configs/ppo.yaml",
                   help="Path to ppo.yaml")
